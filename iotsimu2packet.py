...
#with open("tusin2-packet.txt","a")as f:#aは追記、wは上書
           ...
           if Threshold==15:
            ...
            for time in range(timerange): #何秒間やるか
                ...
                for iotgw in IoTGW_list:
                    ...
                    print(time,iotgw.storage_packet_size)
            ...
            for time_burst in range(timerange): #バーストを何秒間やるか
                ...
                for iotgw in IoTGW_list:
                    iotgw.current_packet_size=0
                    print(time_burst+timerange,iotgw.storage_packet_size)
